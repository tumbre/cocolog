...
<div id="image-preview-container">
    ...
    <label id="add-image-button" class="mt-2 mb-4 bg-white rounded-full flex justify-center items-center border border-gray-400 hover:shadow-lg transition duration-300 ease-in-out cursor-pointer">
    ...
    @isset($post)
        @if ($post->image)
            <div class="preview-image-wrapper relative">
                <img id="existing-image" class="rounded-md mt-4 w-full" src="{{ asset('storage/images/'. $post->image) }}">
                <!-- 削除機能は後で実装 -->
